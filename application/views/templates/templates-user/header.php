...
<head>
    ...
    <link href="<?= base_url('assets/'); ?>datatable/datatavles.css" rel="stylesheet" type="text/css">
</head>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    if (!empty($this->session->userdata('email'))) { ?>
                        ...
                        <a class="nav-item nav-link" onclick="information('Waktu Pengambilan Buku 1x24 jam dariBooking!!!')" href="<?php echo base_url() . 'booking/exportToPdf/' . $this->session->userdata('id_user'); ?>">Cetak Bukti Booking</a>
